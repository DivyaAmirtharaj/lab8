...
let intvl1 = IntInterval.Interval (1, 4) ;;
let intvl2 = IntInterval.Interval (2, 6) ;;
...
module type INTERVAL =
  sig
    ...
    val intersect : interval -> interval -> bool
  end ;;
